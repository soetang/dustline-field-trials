...
// Usage: node courtyard/tests/engine-backbuffer-check.js [--source PATH]
...
const usage = 'Usage: node courtyard/tests/engine-backbuffer-check.js [--source PATH]';
...
function main() {
  ...
  const patchFile = path.join(root, 'courtyard/engine/patches/cache-backbuffer-validation.patch');
