...
- Fast check: `npm run test:fast`; without Godot, `npm run test:workspace`. Focused Godot check: `npm run test:courtyard -- pose_reset`; discover names with `--list`. Full checks: `npm test`.
